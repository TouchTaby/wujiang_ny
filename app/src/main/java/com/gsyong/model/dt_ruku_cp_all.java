 ...
 * 类描述：
 * 创建人：YI
 * 创建时间：2018/1/20 11:20
 * 修改人：YI
 * 修改时间：2018/1/20 11:20
 * 修改备注：
 */
public class dt_ruku_cp_all extends dt_ruku_cp_1
{
    public String mingcheng;
    public String hanliang;
    public Integer jianshu;
    public Integer state;//0 未出库 ,1已出库

    public dt_ruku_cp_all()
    {
    }

    public dt_ruku_cp_all(String uid, String listuid, String daima, String cpuid, Integer ylint1, Integer ylint2, Integer
