 ...
 * 类描述：
 * 创建人：YI
 * 创建时间：2018/1/19 12:39
 * 修改人：YI
 * 修改时间：2018/1/19 12:39
 * 修改备注：
 */
public class dt_qiye
{
    public String id;  //企业编号 唯一
    ...
    public String status;//企业状态  1:正常 2:冻结
    public String provinceid;//省份ID
    public String cityid;//城市ID
    public String countyid;//区县ID
    public String townshipid;//街道ID 无用
    public String villageid;//居委会ID 无用
    public String ylint1;//预留
    public String ylint2;//预留
    public String ylint3;//预留
    public String ylint4;//预留
    ...
    public dt_qiye(String id, String mingzi, String mima, String dizhi, String leixing, String fuzeren, String
            fzrshenfenzheng, String fzrdianhua, String yingyezhizhao, String yingyevld1, String yingyevld2, String nyxukehao,
                   String nyvld1, String nyvld2, String addtime, String status, String provinceid, String cityid, String
                              countyid, String townshipid, String villageid, String ylint1, String ylint2, String ylint3,
                   String ylint4, String ylstr1, String ylstr2, String ylstr3, String ylstr4)
    {
        this.id = id;
        this.mingzi = mingzi;
        this.mima = mima;
    ...
    public String getYlint4()
    {
        return ylint4;
    }

    public void setYlint4(String ylint4)
    {
        this.ylint4 = ylint4;
    }
