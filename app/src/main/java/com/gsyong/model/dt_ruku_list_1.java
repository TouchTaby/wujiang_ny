 ...
 * 修改备注：
 */
public class dt_ruku_list_1
{
    public String uid; //GUID 32位唯一字符串 不带符号，字母小写  如：077a2585e54044b1bbfd112be6371f24
    public String addtime;//创建时间   入库时间
    public String bianhao;//入库单编号 可以使用 yyyyMMddHHmmssffff 格式化日期来得到
    public Integer qiyeid;   //关联的企业ID
    public Integer shuliang; //入库单包含的 流向码个数  总数
    ...
    public dt_ruku_list_1()
    {
    }

    public dt_ruku_list_1(String uid, String addtime, String bianhao, Integer qiyeid, Integer shuliang, String qystaff, Integer
