 ...
 * 修改备注：
 */
public class WareHouseOutAdapter extends BaseAdapter
{
    LayoutInflater layoutInflater;
    List<dt_chuku_cp_all> nowList;


    public WareHouseOutAdapter(Context context, List<dt_chuku_cp_all> data)
    {
    ...
    {
        dt_chuku_cp_all nowMdodel = nowList.get(position);
        WareHouseOutAdapter.ViewHolder viewHolder = null;
        if (viewHolder == null)
        {
            viewHolder = new WareHouseOutAdapter.ViewHolder();
        ...
        {
            viewHolder = (WareHouseOutAdapter.ViewHolder) convertView.getTag();
        }
