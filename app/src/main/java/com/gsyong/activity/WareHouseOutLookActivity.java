...
import com.gsyong.R;
import com.gsyong.adapter.WareHouseOutLookAdapter;
 ...
 * 类描述：
 * 创建人：YI
 * 创建时间：2018/1/22 12:48
 * 修改人：YI
 * 修改时间：2018/1/22 12:48
 * 修改备注：
 */
public class WareHouseOutLookActivity extends AppCompatActivity implements View.OnClickListener, AdapterView
    ...
    private List<dt_chuku_list_all> dt_chuku_list_allList = new ArrayList<>();
    private WareHouseOutLookAdapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_warehouseoutlook);
        context = WareHouseOutLookActivity.this;
    ...
    private void initView() {
        ...
        String[] stateStrings = getResources().getStringArray(R.array.wareHouseOutState);
        //适配器
        ArrayAdapter<String> adapterState = new ArrayAdapter<String>(context, R.layout.spinnertext, stateStrings);
        // 设置下拉列表的风格
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(context, WareHouseOutActivity.class);
        String now_ruku_list_uid = dt_chuku_list_allList.get(position).getUid();
        int state = dt_chuku_list_allList.get(position).getState();
        String shouhuodanwei = dt_chuku_list_allList.get(position).getShouhuodanwei();
        intent.putExtra("uid", now_ruku_list_uid);
        intent.putExtra("state", state);
        intent.putExtra("shouhuodanwei", shouhuodanwei);
    ...
    private void bindData() {
        ...
        dt_chuku_list_allList = wareHouseOutBll.get_chuku_listInfo(tvStartTime.getText().toString(), endTimeValue, nowState);
        adapter = new WareHouseOutLookAdapter(context, dt_chuku_list_allList);
