...
public class dt_chuku_list
{
    ...
    public dt_chuku_list()
    {
    }

    public dt_chuku_list(String _uid, String _addtime, String _bianhao, Integer _qiyeid, Integer _shuliang, String _qystaff,
